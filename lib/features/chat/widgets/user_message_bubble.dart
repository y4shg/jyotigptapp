...
class _UserMessageBubbleState extends ConsumerState<UserMessageBubble> {
  ...
  List<JyotiGPTappContextMenuAction> _buildMessageActions(BuildContext context) {
  ...
  Widget _buildUserMessage() {
    ...
    final inlineEditTextColor = context.jyotigptappTheme.textPrimary;
    final inlineEditFill = context.jyotigptappTheme.surfaceContainer.withValues(
      alpha: 0.92,
    );
                  ...
                  Flexible(
                    child: ConstrainedBox(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: context.jyotigptappTheme.chatBubbleUser,
                        ...
                        child: _isEditing
                            ...
                            : Text(
                                ...
                                style: AppTypography.chatMessageStyle.copyWith(
                                  color:
                                      context.jyotigptappTheme.chatBubbleUserText,
                                ),
                                softWrap: true,
