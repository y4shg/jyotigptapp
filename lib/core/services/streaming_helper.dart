    ...
    try {
      ...
      if (type == 'chat:completion' && payload != null) {
        ...
        try {
          ...
          // Set the error field on the message for proper JyotiGPT round-trip
      ...
      return ThemedDialogs.buildBase(
        ...
        content: Column(
          ...
          children: [
            if (message.isNotEmpty) ...[
              Text(
                message,
                style: TextStyle(color: dialogCtx.jyotigptappTheme.textSecondary),
              ),
        ...
        actions: [
          AdaptiveButton(
            ...
            textColor: dialogCtx.jyotigptappTheme.textSecondary,
          ...
          AdaptiveButton(
            ...
            textColor: dialogCtx.jyotigptappTheme.buttonPrimary,
            style: AdaptiveButtonStyle.plain,
          ),
        ],
      );
