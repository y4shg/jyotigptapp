...
class SettingsService {
  ...
  static const String _voiceCallNotificationsEnabledKey =
      PreferenceKeys.voiceCallNotificationsEnabled;
  ...
  static Future<void> saveSettings(AppSettings settings) async {
    ...
    final updates = <String, Object?>{
      ...
      _voiceCallNotificationsEnabledKey: settings.voiceCallNotificationsEnabled,
    };
  ...
  static Future<bool> getVoiceCallNotificationsEnabled() {
    final value =
        _preferencesBox().get(_voiceCallNotificationsEnabledKey) as bool?;
    return Future.value(value ?? true);
  }

  static Future<void> setVoiceCallNotificationsEnabled(bool value) {
    return _preferencesBox().put(_voiceCallNotificationsEnabledKey, value);
  }
  ...
  static AppSettings _loadSettingsSync(Box<dynamic> box) {
    return AppSettings(
      ...
      voiceCallNotificationsEnabled:
          (box.get(_voiceCallNotificationsEnabledKey) as bool?) ?? true,
    );
  }
}
...
class AppSettings {
  ...
  final bool voiceCallNotificationsEnabled;
  const AppSettings({
    ...
    this.voiceCallNotificationsEnabled = true,
  });
  ...
  AppSettings copyWith({
    ...
    bool? voiceCallNotificationsEnabled,
  }) {
    return AppSettings(
      ...
      voiceCallNotificationsEnabled:
          voiceCallNotificationsEnabled ?? this.voiceCallNotificationsEnabled,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is AppSettings &&
        ...
        other.voiceCallNotificationsEnabled == voiceCallNotificationsEnabled &&
...
class AppSettingsNotifier extends _$AppSettingsNotifier {
  ...
  Future<void> setVoiceCallNotificationsEnabled(bool value) async {
    if (state.voiceCallNotificationsEnabled == value) {
      return;
    }
    state = state.copyWith(voiceCallNotificationsEnabled: value);
    await SettingsService.setVoiceCallNotificationsEnabled(value);
  }
